    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="text" name="employer_name" class="form-control" placeholder="Current Employer Name" required>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
                <strong>Employee Code <span style="color: red;">*</span></strong>
                <input type="text" name="employee_code" class="form-control" placeholder="Employee Code" required>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="number" name="contact_number" class="form-control" placeholder="Contact Number" required oninput="checkMaxLength(this, 10)">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
                <strong>Family Contact Number <span style="color: red;">*</span></strong>
                <input type="number" name="family_contact_number" class="form-control" placeholder="Family Contact Number" required oninput="checkMaxLength(this, 10)">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <div class="form-group">
                ...
                <input type="text" id="dob" name="dob" class="form-control datepicker txt_datepicker" placeholder="Date of Birth" required autocomplete="off">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="text" name="card_date_of_issue" id="card_date_of_issue" class="form-control txt_datepicker" placeholder="Date of Issue (Card)" required autocomplete="off">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
                <strong>Valid Till (Card) <span style="color: red;">*</span></strong>
                <input type="text" name="card_valid_till" id="card_valid_till" class="form-control txt_datepicker" placeholder="Valid Till (Card)" required autocomplete="off">
            </div>
        </div>
