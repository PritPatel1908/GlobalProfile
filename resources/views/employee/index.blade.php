...
<table class="table table-striped table-bordered dt-responsive nowrap" id="tbl_employee" style="width:100%">
	...
	<a class="btn btn-info" href="{{ URL::to('/employee/view/'.$employee->emp_id) }}" title="View"><i class="fa fa-eye"></i></a>


                    <a class="btn btn-primary" href="{{ route('employee.edit',$employee->id) }}" title="Edit"><i class="fa fa-edit"></i></a>
                    ...
                    <button type="submit" class="btn btn-danger" title="Remove" onclick="return remove('<?php echo $employee->id; ?>');"><i class="fa fa-remove"></i></button>
